...
export default function App() {
  ...
  return (
    <div className="app">
      <header>
        <div className="brand"><span className="logo">Fin</span>Tea <span className="tag">by Rohan Mhetre · financial model builder</span></div>
      ...
      <footer>FinTea by Rohan Mhetre · For educational and informational purposes only. Models are generated from public data and mechanical assumptions; they are not financial or investment advice.</footer>
    </div>
  );
}
